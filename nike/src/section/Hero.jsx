  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl  max-md:text-[72px] max-sm:leading-[62px] font-bold">
        ...
        <p className="font-montserrat text-slate-gray text-md leading-8 mt-6 mb-10 sm:max-w-sm">
          Discover stylish snickers arrivals, quality comfort, and innovation
